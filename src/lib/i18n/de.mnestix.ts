...
export const deMnestix = {
    ...
    productCarbonFootprint: {
        ...
        lifecycleStages: {
            ...
            A3: 'A3 - production',
            'A1-A3': 'A1-A3 - Rohstoffversorgung bis Produktion',
            A4: 'A4 - transport to final destination',
            'A4-A5': 'A4-A5 - Transport bis Montage',
            A5: 'A5 - Installation',
            B1: 'B1 - usage phase',
            B2: 'B2 - maintenance',
            B3: 'B3 - repair',
            ...
            'B1-B7': 'B1-B7 - Nutzungsphase',
            C1: 'C1 - reassembly',
            C2: 'C2 - transport to recycler',
            C3: 'C3 - recycling, waste treatment',
            C4: 'C4 - landfill',
            'C1-C4': 'C1-C4 - Entsorgungsphase',
            'C2-C4': 'C2-C4 - Recycling bis Deponie',
            D: 'D - reuse',
        },
    },
    referenceCounter: {
    ...
    assetIdDocumentation: {
        ...
        industry40Text:
            'Produkte haben eine global einzigartige ID, welche einer oder mehreren Verwaltungsschale(n) zugewiesen werden kann. Im Industrie 4.0 Kontext wird die Verbindung zwischen Asset und Verwaltungsschale über die I4.0 Infrastruktur hergestellt.',
